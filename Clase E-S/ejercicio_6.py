# Realizar un programa que pida dos números enteros. Calcular y mostrar el resto de la división entre ambos números. 
...
mensaje = f"El resto de dividir {primer_numero_ingresado} por {segundo_numero_ingresado} es: {resultado_division}"
